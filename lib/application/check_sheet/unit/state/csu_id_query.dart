...
List<Map<String, dynamic>> listToJsonCSUIDQuery(List<CSUResult> list) {
  return list.map((item) => item.toJson()).toList();
}

List<CSUIDQuery> listCSUIDQueryFromJson(List<dynamic> jsonList) {
  return jsonList
      .map((e) => CSUIDQuery.fromJson(e as Map<String, dynamic>))
      .toList();
}

String listCSUIDQueryToJsonSavable(List<CSUIDQuery> resultList) {
