...
abstract class $CSUResultCopyWith<$Res> {
  ...
  $Res call(
      {bool? inout,
      @JsonKey(name: 'id_cs') int id,
      @JsonKey(name: 'id_gate') int idGate,
      int? defectAmount,
      @JsonKey(name: 'no_defect') int? isDefect,
      String? gate,
      String? frame,
      String? supir1,
      String? supir2,
    ...
    return _then(_value.copyWith(
      ...
      supirSDR: freezed == supirSDR
          ...
          : supirSDR // ignore: cast_nullable_to_non_nullable
              as String?,
      tglKirim: freezed == tglKirim
          ? _value.tglKirim
          : tglKirim // ignore: cast_nullable_to_non_nullable
              as String?,
      tglTerima: freezed == tglTerima
          ? _value.tglTerima
...
class _$_CSUResult implements _CSUResult {
  const _$_CSUResult(
      {required this.inout,
      @JsonKey(name: 'id_cs') required this.id,
      @JsonKey(name: 'id_gate') required this.idGate,
      required this.defectAmount,
      @JsonKey(name: 'no_defect') required this.isDefect,
      required this.gate,
      required this.frame,
...
abstract class _CSUResult implements CSUResult {
  const factory _CSUResult(
          ...
          @JsonKey(name: 'id_cs') required final int id,
          @JsonKey(name: 'id_gate') required final int idGate,
          required final int? defectAmount,
          @JsonKey(name: 'no_defect') required final int? isDefect,
